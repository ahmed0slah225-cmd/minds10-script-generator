...
def render(repo, settings):
    ...
    st.checkbox('🔎 السماح بالبحث العام في الإنترنت', key='use_web_search', help='عند إغلاقه، لا يتم إرسال Google Search. الروابط التي تدخلها أنت تظل مسموحة عبر URL Context.')
    st.json({
